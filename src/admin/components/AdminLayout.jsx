    ...
    <div className="flex min-h-screen bg-gray-100">
      ...
      <div 
        className={`
          ...
          ml-0 
        `}
        /* - lg:ml-64: डेस्कटॉप पर जब साइडबार खुला हो 
           - lg:ml-20: डेस्कटॉप पर जब साइडबार छोटा (collapsed) हो
           - ml-0: मोबाइल पर कोई मार्जिन नहीं क्योंकि साइडबार ऊपर (Overlay) आएगा
        */
      >
